...
from modules.models import TAM_Screenplays
...
default_config = os.path.join(MODEL_CNF_DIR, "student.yaml")
...
with open(os.path.join(DATA_DIR, "train_TRIPOD_{}.pickle".format(
        config["data"]["encoder"])), "rb") as f:
...
with open(os.path.join(DATA_DIR,
                       "labels_train_TRIPOD_silver.pickle"), "rb") as f:
...
train_set = TRIPOD(train_data,
                      ...
                      pretraining=None, noisy_labels=train_labels)
...
model = TAM_Screenplays(config["model"],
...
trainer = BaselineTrainer_Screenplays(val_loader, model, train_loader, dev_loader,
